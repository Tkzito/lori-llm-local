...
4. Dependências opcionais para funcionalidades específicas:  
   - `playwright` + navegadores (`playwright install`) para automação web.  
   - `pandas` e `pandasql` para consultas SQL sobre CSV.  
   - `beautifulsoup4` para parsing HTML fallback.  
   - `duckduckgo-search` (`ddgs`) para buscas web.  
